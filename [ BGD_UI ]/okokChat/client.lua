...
Citizen.CreateThread(function()
	TriggerEvent('chat:addSuggestion', '/'..Config.ClearChatCommand, 'Clear le chat (juste pour vous)',{})
	TriggerEvent('chat:addSuggestion', '/'..Config.ClearEveryonesChatCommand, 'Clear le chat (pour tout le monde)',{})
	...
	TriggerEvent('chat:addSuggestion', '/'..Config.PoliceCommand, 'Faire une annonce LSPD',{})
	TriggerEvent('chat:addSuggestion', '/'..Config.AmbulanceCommand, 'Faire une annonce EMS',{})
end)