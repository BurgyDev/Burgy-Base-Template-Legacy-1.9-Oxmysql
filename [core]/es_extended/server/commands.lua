ESX.RegisterCommand('setcoords', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setjob2', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	...
	{name = 'grade2', help = TranslateCap('command_setjob2_grade2'), type = 'number'}
}})

ESX.RegisterCommand('car', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'cardel', 'dv'}, {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setaccountmoney', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('giveaccountmoney', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	if args.playerId.getAccount(args.account) then
...
if not Config.OxInventory then
	ESX.RegisterCommand('giveitem', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveweapon', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('giveammo', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
		if args.playerId.hasWeapon(args.weapon) then
	...
	ESX.RegisterCommand('giveweaponcomponent', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand({'clearall', 'clsall'}, {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	TriggerClientEvent('chat:clear', -1)
end, true, {help = TranslateCap('command_clearall')})

ESX.RegisterCommand("refreshjobs", {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	ESX.RefreshJobs()
end, true, {help = TranslateCap('command_clearall')})

if not Config.OxInventory then
	ESX.RegisterCommand('clearinventory', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	...
	ESX.RegisterCommand('clearloadout', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('setgroup', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('save', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('saveall', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	Core.SavePlayers()
end, true, {help = TranslateCap('command_saveall')})

ESX.RegisterCommand('group', {"user", "admin", "owner", "dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getGroup() .. "^0")
end, true)

ESX.RegisterCommand('job', {"user", "admin", "owner", "dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob().name.. "^0 - ^5".. xPlayer.getJob().grade_label .. "^0")
end, true)

ESX.RegisterCommand('job2', {"user", "admin", "owner", "dev"}, function(xPlayer, args, showError)
	print(xPlayer.getName()..", You are currently: ^5".. xPlayer.getJob2().name.. "^0 - ^5".. xPlayer.getJob2().grade_label .. "^0")
end, true)

ESX.RegisterCommand('info', {"user", "admin", "owner", "dev"}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('coords', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('tpm', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent("esx:tpm")
end, true)

ESX.RegisterCommand('goto', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('bring', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
...
ESX.RegisterCommand('kill', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent("esx:killPlayer")
end, true, {help = TranslateCap('command_kill'), validate = true, arguments = {
	{name = 'playerId', help = TranslateCap('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('freeze', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "freeze")
end, true, {help = TranslateCap('command_freeze'), validate = true, arguments = {
	{name = 'playerId', help = TranslateCap('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand('unfreeze', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	args.playerId.triggerEvent('esx:freezePlayer', "unfreeze")
end, true, {help = TranslateCap('command_unfreeze'), validate = true, arguments = {
	{name = 'playerId', help = TranslateCap('commandgeneric_playerid'), type = 'player'}
}})

ESX.RegisterCommand("noclip", {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
	xPlayer.triggerEvent('esx:noclip')
end, false)

ESX.RegisterCommand('players', {'admin', 'owner', 'dev'}, function(xPlayer, args, showError)
